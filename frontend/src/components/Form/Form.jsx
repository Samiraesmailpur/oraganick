...
import { fullNameRegex, emailRegex, numberRegex } from "@helpers/regex";
import "./Form.scss";
...
const OrderForm = ({ handleFormSubmit }) => {
  ...
  const SignupSchema = Yup.object().shape({
    fullName: Yup.string()
      .matches(
        fullNameRegex,
        "Please enter a valid name. It should start with a capital letter, followed by at least 3 lowercase letters"
      )
